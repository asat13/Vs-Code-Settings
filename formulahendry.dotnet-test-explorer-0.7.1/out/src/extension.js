...
function activate(context) {
    const testResults = new testResultsFile_1.TestResultsFile();
    const testDirectories = new testDirectories_1.TestDirectories();
    const testCommands = new testCommands_1.TestCommands(testResults, testDirectories);
    ...
    const dotnetTestExplorer = new dotnetTestExplorer_1.DotnetTestExplorer(context, testCommands, testResults, statusBar);
